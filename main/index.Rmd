...
The following section will outline the methodology of this report, which is replicable using the accompanying `R` scripts. The next section will present the results, evaluating the models, and visualising the semantic information extracted from tweets. The final section will present conclusions and recommendations.
...
```{r appleplt, fig.cap = "Chatterplot showing words and their associated sentiment in relation to tweets contaiing the word Apple. Large words are more frequent."}
