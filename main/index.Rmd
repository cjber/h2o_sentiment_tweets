...
```{r appleplt, fig.cap = "Chatterplet showing words and their associated sentiment in relation to tweets contaiing the word Apple. Large words are more frequent."}
...
The full code is available [here](https://github.com/cjber/h2o_sentiment_tweets).
